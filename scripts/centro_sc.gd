...
@export var raio: float = 200.0 # Comprimento da linha
@export var velocidade_angular: float = 2.0 # Velocidade de rotação em radianos/segundo
@export var espessura_linha: float = 8.0 # Espessura da linha horizontal giratória

@export var cor_circunferencia: Color = Color(0.12, 0.15, 0.22, 0.8) # Cor base da circunferência
@export var cor_borda: Color = Color(0.35, 0.45, 0.6, 0.8) # Bordas interna e externa
@export var cor_area_alvo: Color = Color(0.2, 0.85, 0.4, 0.95) # Área de 45° (outra cor em local aleatório)
